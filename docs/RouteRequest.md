...
| allowOnlyScheduledTransitDirectToStop                                                                |        `boolean`       | If a stop/station was explicitly provided as a GenericLocation, only allow arriving by scheduled transit.                          | *Optional* | `false`                  | Transvision |
...
| maxCarSpeed                                                                                          |        `double`        | Max car speed along streets, in meters per second                                                                                  | *Optional* | `40.0`                   |     2.0     |
...
|    flexToScheduledTransitDistanceRatio                                                               |        `double`        | Ration of walking / flex distance                                                                                                  | *Optional* | `0.0`                    | Transvision |
|    flexToScheduledTransitDurationRatio                                                               |        `double`        | Ration of walking / flex duration                                                                                                  | *Optional* | `0.0`                    | Transvision |
